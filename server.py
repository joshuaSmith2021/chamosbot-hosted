...
def bedwars():
    ...
    # Convert display times into the javascript array that will be rendered
    display_times = ', '.join(map(lambda x: '\'{0}\''.format(x), display_times))
    ...
    return render_template('bedwars.html', display_times=display_times)
